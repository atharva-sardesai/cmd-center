...
const AWARENESS_ITEMS = [
  ...
  { title: 'OT Assets: 87 new RTU devices enrolled — India Site. Category: RTU.',              source: 'OT Asset Registry',   risk_score: 4, published: ago(170), coords: [19.08,  72.88] },
  ...
  { title: 'Access Recert: India Site — 41 expired access grants removed. Cert cycle closed.', source: 'Access Recertification', risk_score: 5, published: ago(400), coords: [19.08, 72.88] },
